...
public class MainActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private String personality = "Sonam";
    private String field = "IAS";
...
// Add new deck if one doesn't already exist
        ...
        /* Sample Code to add Deck and card
        // Test Code to add basic card
...
*/
        ...
        /* Following is the code with which it apisample-master came up with
