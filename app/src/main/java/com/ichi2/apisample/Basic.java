...
public class Basic extends MainActivity {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.button5:
                ...
                final AddContentApi api = new AddContentApi(Basic.this);

                // Add new deck if one doesn't already exist
                Long did = api.findDeckIdByName("Basic");

                if (did != null) {
                    //Toast.makeText(MainActivity.this, "Found Deck PIN!", Toast.LENGTH_LONG).show();
                }

                Long mid = api.findModelIdByName("Basic", 2);
                if (mid != null) {
                ...
                api.addNewNote(mid, did, new String[]{front, back}, "Basic");

                Toast.makeText(Basic.this, "\n Front : " + front + "\n Back : " + back  , Toast.LENGTH_LONG).show();
            ...
            default:
                Toast.makeText(Basic.this, "Please select some text first!!!", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hideKeyboard(Basic.this); // not working
